...
class Level_01(Level):
    ...
    def __init__(self, player, coin, score):
        ...
        # - add extras HenchBros
        henchbros = MovingExtra('henchBros.png', 183, 231)
        henchbros.rect.x = 2150
        henchbros.rect.y = SCREEN_HEIGHT - 230
        henchbros.boundry_left = 1850
        henchbros.boundary_right = 2150
        henchbros.change_x =  5
        henchbros.level = self
        self.extra_list.add(henchbros)
